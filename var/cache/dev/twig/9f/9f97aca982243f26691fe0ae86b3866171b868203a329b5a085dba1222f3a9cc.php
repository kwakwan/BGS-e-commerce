...
class __TwigTemplate_9506a82fe15089850d8800e9e5f1b8af05780d61e01f519e64b5be797f5668e8 extends Twig_Template
{
    private $source;
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-dark\" style=\"margin-bottom:20px\">";
        // line 3
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-dark\" style=\"margin-bottom:20px\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "/Users/paulgambier/Desktop/Rendu/codac_pff/app/templates/user/_form.html.twig");
    }
}
