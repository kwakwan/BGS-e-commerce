...
class __TwigTemplate_ce4cda5ea469a32e04760d096d307d74bdb5898bd2f1062fdbd3fbb74fc9b4f4 extends Twig_Template
{
    private $source;
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["id"] => $context["filter"]) {
                ...
                if ((isset($context["ignored_filter"]) || array_key_exists("ignored_filter", $context) ? $context["ignored_filter"] : (function () { throw new Twig_Error_Runtime('Variable "ignored_filter" does not exist.', 114, $this->source); })())) {
                    ...
                    // line 117
                    echo "                                ";
                    echo twig_escape_filter($this->env, twig_var_dump($this->env, $context, $context["filter"]), "html", null, true);
                    echo "
                            ";
                }
                // line 119
